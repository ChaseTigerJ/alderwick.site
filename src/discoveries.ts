export const discoveries = [
  { title: 'A letter from Pip', text: '“A place is only a place until someone calls it home.” Pip has saved the first letter for you.', item: 'One warm welcome', icon: '01', actionLabel: 'Open Pip’s mailbox' },
  { title: 'Khloé was here.', text: 'A pink collar, muddy paws, and absolutely no regrets. Every great settlement needs a very good dog.', item: 'One very good companion', icon: '02', actionLabel: 'Play with Khloé' },
  { title: 'Supplies for the shore', text: 'A few tools. A little courage. Just enough to turn an unfamiliar shore into the beginning of something.', item: 'One grand beginning', icon: '03', actionLabel: 'Nudge the supply ship' },
